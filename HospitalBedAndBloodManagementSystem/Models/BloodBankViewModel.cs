...
namespace HospitalBedAndBloodManagementSystem.Models
{
    public class BloodBankViewModel
    {
        ...
        public string BloodBankTypeName { get; set; }
        public int BloodBankTypeId { get; set; }
        ...
        public int Save()
        {
            ...
            using (DataManager oDm = new DataManager())
            {
                oDm.Add("@pBloodBankId", SqlDbType.Int,ParameterDirection.InputOutput, this.BloodBankId);
                oDm.Add("@pBloodBankname", SqlDbType.VarChar, 50, this.BloodBank);
                ...
                oDm.Add("@pBloodBankTypeId", SqlDbType.Int, this.BloodBankTypeId);
                ...
                oDm.CommandType = CommandType.StoredProcedure;
                result = oDm.ExecuteNonQuery("BloodBankMaster_Save");
            }

            return result;
        }

        public DataTable GetAllBloodBank()
        {
            ...
            using (DataManager oDm = new DataManager())
            {
                ...
                oDm.CommandType = CommandType.StoredProcedure;
                Dt = oDm.ExecuteDataTable("BloodBankMaster_GetAll");
            }
        ...
        public void GetBloodBankById(int Id)
        {
            using (DataManager oDm = new DataManager())
            {
                oDm.Add("@pBloodBankId", SqlDbType.Int, Id);
                oDm.CommandType = CommandType.StoredProcedure;
                this.Dt = oDm.ExecuteDataTable("BloodBankMaster_GetById");
                if (this.Dt != null)
                {
                    foreach (DataRow dr in this.Dt.Rows)
                    {
                        this.BloodBankId = (@dr["BloodBankId"] == DBNull.Value) ? 0 : Convert.ToInt32(@dr["BloodBankId"]);
                        this.BloodBank = (@dr["BloodBankName"] == DBNull.Value) ? "" : @dr["BloodBankName"].ToString();
                        ...
                        this.BloodBankTypeId = (@dr["BloodBankType"] == DBNull.Value) ? 0 : Convert.ToInt32(@dr["BloodBankType"]);
        ...
        public int Delete(int Id)
        {
            ...
            using (DataManager oDm = new DataManager())
            {
                oDm.Add("@pBloodBankId", SqlDbType.Int,ParameterDirection.InputOutput, Id);
                oDm.CommandType = CommandType.StoredProcedure;
                oDm.ExecuteNonQuery("BloodBankMaster_Delete");
                result = (int)oDm["@pBloodBankId"].Value;
            }
