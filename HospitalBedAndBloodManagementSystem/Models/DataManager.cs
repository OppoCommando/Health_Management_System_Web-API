...
namespace HospitalBedAndBloodManagementSystem.Models
{
    ...
    internal sealed class DataManager : IDisposable
    {
        ...
        public DataManager()
        {
            ...
            //    CompanyId = Convert.ToInt32(HttpContext.Current.User.Identity.Name.Split(',')[2]);

            SqlCmd = new SqlCommand();
            strConnectionString = System.Configuration.ConfigurationManager.AppSettings["ConnectionString"].ToString();
            //if (CompanyId == 1)
            //    strConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["MarkSecuritasCS"].ToString();
            //if (CompanyId == 2)
            //    strConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["DaleSecuritasCS"].ToString();
            //if (CompanyId == 3)
            //    strConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["BrookeCS"].ToString();
        }
